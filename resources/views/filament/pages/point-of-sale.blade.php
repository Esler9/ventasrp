<x-filament-panels::page>
    <div class="space-y-6 px-2 sm:px-4 lg:px-8">
        <div class="w-full rounded-3xl bg-white p-4 shadow-lg ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
        ...
        <div class="w-full rounded-3xl bg-white shadow-lg ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
